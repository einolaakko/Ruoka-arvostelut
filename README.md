...
* Käyttäjä pystyy lisäämään sovellukseen teitokohteita (tässä tapauksessa arvosteluja ja arvosteltavia). Lisäksi käyttäjä pystyy muokkaamaan ja poistamaan lisäämiään tietokohteita.
...
* Käyttäjä pystyy valitsemaan tietokohteelle yhden tai useamman luokittelun (esim. olut tai pasta). Mahdolliset luokat ovat tietokannassa.
